...
public class GoogleChatNotificationsLoggerTest {
    ...
    public void setup() {
        ...
        logger = new GoogleChatNotificationsLogger(system, user, false);
    }
    ...
    public void shouldWriteInfoMessagesToSystemAndUserLogs() {
        String expectedUserLog = "[Google Chat Notification] a 100% useful sort of message";
